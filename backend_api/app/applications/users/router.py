...
from applications.users.schemas import BaseFields, RegisterUserFields, BaseUserInfo
...
async def create_user(request: Request, new_user: RegisterUserFields, session: AsyncSession = Depends(get_async_session)) -> BaseFields:
